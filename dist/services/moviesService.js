...
export const upsertMovie = async (imdbID) => {
    ...
    const movie = await Movie.findOneAndUpdate({ provider: 'omdb', imdbID }, {
        $setOnInsert: {
            provider: 'omdb',
            imdbID: data.imdbID,
        },
